...
namespace App\Contexto\Menu\Infraestructura\Eloquent\Models;
...
class MenuModel extends Model
{
    ...
    /**
     * Roles asignados a este menu (pivot menu_rol).
     */
    public function roles(): BelongsToMany
    {
        return $this->belongsToMany(RolModel::class, 'menu_rol', 'menu_id', 'rol_id')
            ->withTimestamps();
    }
}
