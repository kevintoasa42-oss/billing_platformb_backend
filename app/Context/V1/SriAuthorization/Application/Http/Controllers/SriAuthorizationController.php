...
namespace App\Context\V1\SriAuthorization\Application\Http\Controllers;

use App\Context\V1\SriAuthorization\Application\UseCases\AuthorizeInvoiceUseCase;
