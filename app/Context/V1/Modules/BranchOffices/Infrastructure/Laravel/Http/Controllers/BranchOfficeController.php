...
namespace App\Context\V1\Modules\BranchOffices\Infrastructure\Laravel\Http\Controllers;

use App\Context\V1\Modules\BranchOffices\Application\DTOs\BranchOfficeDTO;
use App\Context\V1\Modules\BranchOffices\Application\UseCases\BranchOfficeCrudService;
use App\Context\V1\Modules\BranchOffices\Domain\Exceptions\BranchOfficeNotFoundException;
use App\Context\V1\Modules\BranchOffices\Infrastructure\Laravel\Http\Requests\CreateBranchOfficeRequest;
use App\Context\V1\Modules\BranchOffices\Infrastructure\Laravel\Http\Requests\UpdateBranchOfficeRequest;
