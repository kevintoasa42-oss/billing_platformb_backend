...
namespace App\Context\V1\Modules\Clients\Infrastructure\Laravel\Eloquent\Repositories;
...
{
    public function __construct(private readonly ClientMapperInterface $mapper)
    {
    }
