...
class CreateEnterpriseRequest extends EnterpriseFormRequest
{
     ...
     *
     * @param  array  $data
     * @return \App\Context\V1\Modules\Clients\Enterprise\Application\DTOs\EnterpriseDTO
     */
    public static function toDTO(array $data): \App\Context\V1\Modules\Clients\Enterprise\Application\DTOs\EnterpriseDTO
    {
        return \App\Context\V1\Modules\Clients\Enterprise\Application\DTOs\EnterpriseDTO::fromArray($data);
    }
}
