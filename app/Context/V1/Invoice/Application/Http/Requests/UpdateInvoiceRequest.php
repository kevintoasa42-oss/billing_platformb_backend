...
class UpdateInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'total_without_taxes' => 'sometimes|required|numeric|min:0',
            ...
            'items.*.taxes.*.taxable_base' => 'required_with:items.*.taxes|numeric|min:0',
            'items.*.taxes.*.value' => 'required_with:items.*.taxes|numeric|min:0',
            ...
            'payments.*.payment_method' => 'required_with:payments|string|max:2',
