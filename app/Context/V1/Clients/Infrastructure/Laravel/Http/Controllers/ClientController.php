...
namespace App\Context\V1\Clients\Infrastructure\Laravel\Http\Controllers;

use App\Context\V1\Clients\Application\DTOs\ClientDTO;
use App\Context\V1\Clients\Application\UseCases\ClientCrudService;
use App\Context\V1\Clients\Domain\Exceptions\ClientNotFoundException;
use App\Context\V1\Clients\Infrastructure\Laravel\Http\Requests\CreateClientRequest;
use App\Context\V1\Clients\Infrastructure\Laravel\Http\Requests\UpdateClientRequest;
