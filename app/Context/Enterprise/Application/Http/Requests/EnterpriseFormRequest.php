...
abstract class EnterpriseFormRequest extends FormRequest
{
     ...
     *
     * @return \App\Context\Enterprise\Infrastructure\Eloquent\Models\UserModel|null
     */
    ...
    public function getEnterpriseRuc(): ?string
    {
        ...
        return \App\Context\Enterprise\Infrastructure\Eloquent\Models\EnterpriseModel::where('id', $enterpriseId)
            ->value('ruc');
    }
