...
/**
 * Credit note subtype with original document reference, reason, settlement impact and action. Consolidated with ALTERs from 020. RLS enabled.
 */
return new class extends Migration
{
    public function up(): void
    {
        DB::connection('master_v3')->unprepared(<<<'SQL'
            CREATE TABLE IF NOT EXISTS fiscal.credit_notes(
            ...
            ALTER TABLE fiscal.credit_notes ENABLE ROW LEVEL SECURITY;
            ALTER TABLE fiscal.credit_notes FORCE ROW LEVEL SECURITY;
            DROP POLICY IF EXISTS tenant_isolation ON fiscal.credit_notes;
            CREATE POLICY tenant_isolation ON fiscal.credit_notes
    ...
    {
        DB::connection('master_v3')->unprepared(<<<'SQL'
            DROP TABLE IF EXISTS fiscal.credit_notes CASCADE;
            SQL);
    }
};
